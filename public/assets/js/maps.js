...
var mapDivs = document.querySelectorAll('.map'); //maps.js
var _iteratorNormalCompletion = true;
var _didIteratorError = false;
var _iteratorError = undefined;
...
try {
    ...
    for (var _iterator = mapDivs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var div = _step.value;

        (0, _mapboxUtils2.default)(div);
    }
} catch (err) {
    _didIteratorError = true;
    _iteratorError = err;
