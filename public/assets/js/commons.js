...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mapbox_gl_dist_mapbox_gl_js__ = __webpack_require__(10);
...
/* harmony export (immutable) */ exports["a"] = addMapTo;
...
var parseLocation = function parseLocation(text) {
    //text = `POINT(lon lat)`
    var coords = /POINT\((.*)\)/.exec(text);
    var longitude = coords[1].split(' ')[0];
    var latitude = coords[1].split(' ')[1];

    return { latitude: latitude, longitude: longitude };
};

//the main function
function addMapTo(div) {
    ...
    if (places != null) {
        ...
        try {
            for (var _iterator = places[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var placeLongitude = parseLocation(place.location).longitude;
                var placeLatitude = parseLocation(place.location).latitude;
                data.features.push({
                    "type": "Feature",
                    "geometry": {
                        "type": "Point",
...
},{"../util/util":127,"csscolorparser":132,"mapbox-gl-function":161}],61:[function(require,module,exports){
...
},{"../util/util":127,"./parse_color":60,"mapbox-gl-function":161}],63:[function(require,module,exports){
...
},{"../util/util":127,"./style_layer":63,"feature-filter":135,"mapbox-gl-style-spec/lib/group_by_layout":165}],70:[function(require,module,exports){
...
},{"mapbox-gl-style-spec/lib/validate_style.min":187}],73:[function(require,module,exports){
...
},{"lodash.isarray":156,"lodash.istypedarray":158,"lodash.keys":159}],153:[function(require,module,exports){
...
},{"lodash._baseisequal":152,"lodash._bindcallback":153}],158:[function(require,module,exports){
...
},{"lodash._getnative":154,"lodash.isarguments":155,"lodash.isarray":156}],160:[function(require,module,exports){
...
},{"./util/ref_properties":168}],163:[function(require,module,exports){
...
},{"lodash.isequal":157}],164:[function(require,module,exports){
...
},{"./util/ref_properties":168,"fast-stable-stringify":134}],166:[function(require,module,exports){
...
},{"../error/validation_error":164,"../util/extend":166,"../util/get_type":167,"./validate_array":171,"./validate_boolean":172,"./validate_color":173,"./validate_constants":174,"./validate_enum":175,"./validate_filter":176,"./validate_function":177,"./validate_layer":179,"./validate_light":181,"./validate_number":182,"./validate_object":183,"./validate_source":185,"./validate_string":186}],171:[function(require,module,exports){
...
},{"../error/validation_error":164,"../util/get_type":167,"csscolorparser":132}],174:[function(require,module,exports){
...
},{"../error/validation_error":164,"../util/get_type":167,"./validate":170}],182:[function(require,module,exports){
