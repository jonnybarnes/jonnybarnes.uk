...
var _parseLocation = __webpack_require__(1);

var _parseLocation2 = _interopRequireDefault(_parseLocation);

var _selectPlace = __webpack_require__(4);

var _selectPlace2 = _interopRequireDefault(_selectPlace);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _toArray(arr) { return Array.isArray(arr) ? arr : Array.from(arr); } //mapbox-utils.js


_mapboxGl2.default.accessToken = 'pk.eyJ1Ijoiam9ubnliYXJuZXMiLCJhIjoiY2l2cDhjYW04MDAwcjJ0cG1uZnhqcm82ayJ9.qA2zeVA-nsoMh9IFrd5KQw';
...
exports.default = enableLocateButton;

var _newnoteGetlocation = __webpack_require__(13);

var _newnoteGetlocation2 = _interopRequireDefault(_newnoteGetlocation);
...
function enableLocateButton(button) {
    if ('geolocation' in navigator) {
        if (button.addEventListener) {
            ...
            button.addEventListener('click', _newnoteGetlocation2.default);
        }
    }
} //newnote-button.js
...
exports.default = persistFormData;

var _webStorage = __webpack_require__(16);

var _webStorage2 = _interopRequireDefault(_webStorage);

var _alertify = __webpack_require__(3);
...
var loadData = function loadData() {
    ...
    replyTo.value = _webStorage2.default.getItem('replyTo');
    var content = document.querySelector('#content');
    content.value = _webStorage2.default.getItem('content');
};

var saveData = function saveData() {
    var replyTo = document.querySelector('#in-reply-to');
    var content = document.querySelector('#content');
    _webStorage2.default.setItem('replyTo', replyTo.value);
    _webStorage2.default.setItem('content', content.value);
    _alertify2.default.success('Auto-saved data');
};

var clearData = function clearData() {
    _webStorage2.default.removeItem('replyTo');
    _webStorage2.default.removeItem('content');
};
...
exports.default = addMapWithPlaces;

var _alertify = __webpack_require__(3);

var _alertify2 = _interopRequireDefault(_alertify);

var _mapboxUtils = __webpack_require__(2);

var _mapboxUtils2 = _interopRequireDefault(_mapboxUtils);

var _parseLocation = __webpack_require__(1);

var _parseLocation2 = _interopRequireDefault(_parseLocation);

var _newplaceMicropub = __webpack_require__(14);

var _newplaceMicropub2 = _interopRequireDefault(_newplaceMicropub);
    ...
    if (places != null) {
        ...
        try {
            for (var _iterator = places[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                console.log(place);
                var parsedCoords = (0, _parseLocation2.default)(place.location);
...
function addMapWithPlaces(div, position) {
    fetch('/micropub/places?latitude=' + position.coords.latitude + '&longitude=' + position.coords.longitude + '&u=' + position.coords.accuracy, {
        ...
        if (response.ok) {
            ...
            _alertify2.default.reset();
            _alertify2.default.error('Non OK response');
        }
    }).then(function (json) {
        if (json.error == true) {
            _alertify2.default.reset();
            _alertify2.default.error(json.error_description);
        }
        var places = null;
        if (json.places.length > 0) {
            places = json.places;
        }
        var map = (0, _mapboxUtils2.default)(div, position, places);
        ...
        var newPlaceForm = (0, _newplaceMicropub2.default)(map);
...
var _nearbyPlaces = __webpack_require__(12);

var _nearbyPlaces2 = _interopRequireDefault(_nearbyPlaces);
...
function getLocation() {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        (0, _nearbyPlaces2.default)(mapDiv, position);
    });
...
exports.default = makeNewPlaceForm;

var _submitPlace = __webpack_require__(15);

var _submitPlace2 = _interopRequireDefault(_submitPlace);
...
exports.default = submitNewPlace;
...
function submitNewPlace(map) {
    ...
    fetch('/places/new', {
        ...
        _alertify2.default.reset();
        _alertify2.default.error(placeError);
    });
} //submit-place.js
...
var _newnoteButton = __webpack_require__(10);

var _newnoteButton2 = _interopRequireDefault(_newnoteButton);

var _persistForm = __webpack_require__(11);

var _persistForm2 = _interopRequireDefault(_persistForm);
...
(0, _newnoteButton2.default)(button);
(0, _persistForm2.default)();

/***/ })
/******/ ]);
//# sourceMappingURL=newnote.js.map