...
function parseLocation(text) {
    var coords = /POINT\((.*)\)/.exec(text);
    var parsedLongitude = coords[1].split(' ')[0];
    var parsedLatitude = coords[1].split(' ')[1];
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mapbox_gl_dist_mapbox_gl_js__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parse_location__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__select_place__ = __webpack_require__(4);
/* harmony export (immutable) */ __webpack_exports__["a"] = addMap;
...
__WEBPACK_IMPORTED_MODULE_0_mapbox_gl_dist_mapbox_gl_js___default.a.accessToken = 'pk.eyJ1Ijoiam9ubnliYXJuZXMiLCJhIjoiY2l2cDhjYW04MDAwcjJ0cG1uZnhqcm82ayJ9.qA2zeVA-nsoMh9IFrd5KQw';

//define some functions to be used in the default function.
var titlecase = function titlecase(string) {
    return string.split('-').map(function (_ref) {
...
var addMapTypeOption = function addMapTypeOption(map, menu, option) {
    ...
    if (places != null) {
        ...
        try {
            for (var _iterator = places[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var placeLongitude = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__parse_location__["a" /* default */])(place.location).longitude;
                var placeLatitude = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__parse_location__["a" /* default */])(place.location).latitude;
                data.features.push({
                    'type': 'Feature',
                    'geometry': {
                        'type': 'Point',
    ...
    if (position != null) {
        map.on('click', function (e) {
            ...
            if (features.length) {
                ...
                __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__select_place__["a" /* default */])(features[0].properties.uri);
            }
        });
    }
    if (data.features && data.features.length > 1) {
        var bounds = new __WEBPACK_IMPORTED_MODULE_0_mapbox_gl_dist_mapbox_gl_js___default.a.LngLatBounds();
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = selectPlaceInForm;
//select-place.js
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__newnote_getlocation__ = __webpack_require__(13);
/* harmony export (immutable) */ __webpack_exports__["a"] = enableLocateButton;
//newnote-button.js



function enableLocateButton(button) {
    if ('geolocation' in navigator) {
        if (button.addEventListener) {
            //if we have javascript, event listeners and geolocation
            //make the locate button clickable and add event
            button.disabled = false;
            button.addEventListener('click', __WEBPACK_IMPORTED_MODULE_0__newnote_getlocation__["a" /* default */]);
        }
    }
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_webStorage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_webStorage___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_webStorage__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_alertify_js__ = __webpack_require__(3);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = persistFormData;
//persist-form.js
...
var loadData = function loadData() {
    var replyTo = document.querySelector('#in-reply-to');
    replyTo.value = __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.getItem('replyTo');
    var content = document.querySelector('#content');
    content.value = __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.getItem('content');
};

var saveData = function saveData() {
    var replyTo = document.querySelector('#in-reply-to');
    var content = document.querySelector('#content');
    __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.setItem('replyTo', replyTo.value);
    __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.setItem('content', content.value);
    __WEBPACK_IMPORTED_MODULE_1_alertify_js___default.a.success('Auto-saved data');
};

var clearData = function clearData() {
    __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.removeItem('replyTo');
    __WEBPACK_IMPORTED_MODULE_0_webStorage___default.a.removeItem('content');
};

function persistFormData() {
    var form = document.querySelector('form[name="micropub"]');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alertify_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mapbox_utils__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parse_location__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__newplace_micropub__ = __webpack_require__(14);
/* harmony export (immutable) */ __webpack_exports__["a"] = addMapWithPlaces;
//nearby-places.js
...
var makeOptionsForForm = function makeOptionsForForm(map, position) {
    var places = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

    //create the <select> element and give it a no location default
    var selectElement = document.createElement('select');
    selectElement.setAttribute('name', 'location');
    var noLocationOption = document.createElement('option');
    ...
    var geoLocationOption = document.createElement('option');
    ...
    if (places != null) {
        ...
        try {
            for (var _iterator = places[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var parsedCoords = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__parse_location__["a" /* default */])(place.location);
    ...
    selectElement.addEventListener('change', function () {
        if (selectElement.value !== 'no-location') {
            var optionLatitude = selectElement[selectElement.selectedIndex].dataset.latitude;
            var optionLongitude = selectElement[selectElement.selectedIndex].dataset.longitude;
...
function addMapWithPlaces(div, position) {
    fetch('/micropub/places?latitude=' + position.coords.latitude + '&longitude=' + position.coords.longitude + '&u=' + position.coords.accuracy, {
        ...
        if (response.ok) {
            ...
            __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.reset();
            __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.error('Non OK response');
        }
    }).then(function (json) {
        if (json.error == true) {
            __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.reset();
            __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.error(json.error_description);
        }
        var places = null;
        if (json.places.length > 0) {
            places = json.places;
        }
        var map = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__mapbox_utils__["a" /* default */])(div, position, places);
        //create a containting div for flexbox styling purposes
        var flexboxDiv = document.createElement('div');
        var options = makeOptionsForForm(map, position, places);
        flexboxDiv.appendChild(options);
        var newPlaceForm = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__newplace_micropub__["a" /* default */])(map);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__nearby_places__ = __webpack_require__(12);
...
function getLocation() {
    ...
    navigator.geolocation.getCurrentPosition(function (position) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__nearby_places__["a" /* default */])(mapDiv, position);
    });
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__submit_place__ = __webpack_require__(15);
/* harmony export (immutable) */ __webpack_exports__["a"] = makeNewPlaceForm;
//newplace-micropub.js



function makeNewPlaceForm(map) {
    ...
    newLocationButton.addEventListener('click', function () {
        ...
        var newPlaceNameDiv = document.createElement('div');
        var newPlaceNameLabel = document.createElement('label');
        ...
        var newPlaceNameInput = document.createElement('input');
        ...
        var newPlaceDescDiv = document.createElement('div');
        var newPlaceDescLabel = document.createElement('label');
        ...
        var newPlaceDescInput = document.createElement('input');
        ...
        var newPlaceLatitudeDiv = document.createElement('div');
        ...
        var newPlaceLatitudeInput = document.createElement('input');
        ...
        var newPlaceLongitudeDiv = document.createElement('div');
        var newPlaceLongitudeLabel = document.createElement('label');
        ...
        var newPlaceLongitudeInput = document.createElement('input');
        ...
        var newPlaceSubmit = document.createElement('button');
        ...
        newPlaceSubmit.addEventListener('click', function () {
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__submit_place__["a" /* default */])(map);
        });
        var form = document.querySelector('fieldset');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alertify_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_alertify_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_alertify_js__);
/* harmony export (immutable) */ __webpack_exports__["a"] = submitNewPlace;
//submit-place.js



function submitNewPlace(map) {
    //create the form data to send
    var formData = new FormData();
    formData.append('place-name', document.querySelector('#place-name').value);
    formData.append('place-description', document.querySelector('#place-description').value);
    ...
    fetch('/places/new', {
        ...
        var newFeatures = source._data.features.filter(function (item) {
        ...
        var newlyCreatedPlaceOption = document.createElement('option');
        ...
        __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.reset();
        __WEBPACK_IMPORTED_MODULE_0_alertify_js___default.a.error(placeError);
    });
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__newnote_button__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__persist_form__ = __webpack_require__(11);
//newnote.js
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__newnote_button__["a" /* default */])(button);
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__persist_form__["a" /* default */])();
